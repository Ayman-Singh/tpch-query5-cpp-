...
bool readTPCHData(const string& table_path, vector<vector<string>> & customer_data,  vector<vector<string>>& orders_data,vector<vector<string>> & lineitem_data,
                  vector<vector<string>>& supplier_data,
                  vector<vector<string>>& nation_data,
